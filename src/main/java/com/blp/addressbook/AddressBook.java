...
public class AddressBook {
    ...
    public static void readCSVFile() throws Exception {
        try {
            BufferedReader br = new BufferedReader(new FileReader("C:\\Users\\praja\\IdeaProjects\\AddressBookDay28\\Contact_Details"));
            String line;
    ...
    public static void writeCSVFile() throws IOException {
        PrintWriter pw = new PrintWriter(new File("C:\\Users\\praja\\IdeaProjects\\AddressBookDay28\\Contact_Details"));
    ...
    public static void main(String[] args) throws Exception {
        ...
        Scanner sc = new Scanner(System.in);
        HashMap<String, com.blp.addressbook.AddressBook> addressBooks = new HashMap<>();
        com.blp.addressbook.AddressBook book1 = new com.blp.addressbook.AddressBook();
        com.blp.addressbook.AddressBook book2 = new com.blp.addressbook.AddressBook();
        com.blp.addressbook.AddressBook book3 = new com.blp.addressbook.AddressBook();
